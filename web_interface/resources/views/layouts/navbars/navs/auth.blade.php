...
<nav class="navbar navbar-expand-lg d-flex justify-content-end " color-on-scroll="500">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse d-flex justify-content-end" id="navigation">
                ...
                <button type="button" class="btn btn-primary" id="interestRate" data-toggle="modal" data-target="#setInterestRate">Set Interest Rate</button>
...
<div class="modal fade" id="setInterestRate" tabindex="-1" role="dialog" aria-labelledby="setInterestRate" aria-hidden="true">
    ...
    <div class="modal-header">
        <!-- ... -->
        <h5 class="modal-title" id="uploadModalLabel">Set Rate</h5>
...
<button type="button" class="btn btn-primary" data-toggle="modal" id="csv" data-target="#uploadModal">Upload CSV FILE</button>
